...
class CircleImageView : ImageView {
    ...
    private fun getCircleBackgroundColor(): Int {
        return mCircleBackgroundColor
    }

    private fun setCircleBackgroundColor(@ColorInt circleBackgroundColor: Int) {
     ...
     *
     */
    @Deprecated("Use {@link #getCircleBackgroundColor()} instead.", ReplaceWith("getCircleBackgroundColor()"))
     ...
     *
     */
    @Deprecated("Use {@link #setCircleBackgroundColor(int)} instead.", ReplaceWith("setCircleBackgroundColor(fillColor)"))
